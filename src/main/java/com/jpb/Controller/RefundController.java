...
public class RefundController {
	...
	@PostMapping("/customer-voucher-failed")
	public ResponseEntity<?> customerVoucherFailed(@RequestBody CustomerInputRequestDTO request, HttpServletRequest httpRequest){
		return service.customerVoucherFailed(request, httpRequest);
	}
