		...
		try {			
			...
			if(!dedupeCheck.isEmpty()) {
				...
				Optional<CustomerMasterEntity> latestRecord = dedupeCheck.stream()
						.filter(records -> (!"SUBMITTED".equalsIgnoreCase(records.getNextActionType())
...
//					externalRefNo = "JPBV" + System.currentTimeMillis();
